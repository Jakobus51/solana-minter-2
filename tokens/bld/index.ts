...
const TOKEN_NAME = "TREECOIN";
const TOKEN_SYMBOL = "TRC";
const TOKEN_DESCRIPTION = "One coin can save one tree";
const TOKEN_IMAGE_NAME = "tree.jpg"; // Replace unicorn.png with your image name
